...
to recalculate-area
  ...
  ask turtles [
    set total-votes count voters in-radius 10 ; APPROVAL VOTING: now get votes from ANY patch within 15 'patches'
  ]
end
...
to-report potential-voter-share
  report count voters with [ choose-party = myself ]
end
...
; report the party with the best fit ideologially, defined as the smallest distance between patch & platform
